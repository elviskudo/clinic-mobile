      ...
      child: Container(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            // AMBIL DATA LANGSUNG DARI OBJEK 'record'
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: ClipOval(
                          child: Image.network(
                            // Jika ada foto dokter dari database, gunakan itu.
                            // Jika tidak, pakai default avatar.
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              // Gabungkan gelar, nama, dan spesialisasi dokter
                              '${doctor?.degree ?? ''} ${doctor?.name ?? 'Unknown Doctor'}, ${doctor?.specialize ?? ''}'
                                  .trim(),
                              maxLines: 1,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            // Warna status dinamis: hijau jika completed (7), biru jika waiting (1)
