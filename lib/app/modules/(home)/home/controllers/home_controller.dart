...
class HomeController extends GetxController {
      ...
      if (userId != null) {
        ...
        if (response != null && response is List) {
          medicalRecords.value =
              response.map((e) => Appointment.fromJson(e)).toList();
        }
      }
    } catch (e) {
  ...
  void navigateToAppointmentDetail1(Appointment appointment) {
    switch (appointment.status) {
      case 1:
        Get.toNamed(Routes.APPOINTMENT, parameters: {
          'appointmentId': appointment.id
        }); // Kirim semua data yang diperlukan ke halaman appointment
        break;
      case 2:
      case 4:
      case 5:
      ...
      case 6:
        Get.toNamed(Routes.REDEEM_MEDICINE,
            arguments:
                appointment.id); // Replace with your redeem medicine route
        break;
      case 7:
      case 3:
        Get.snackbar('Info', 'This appointment is disabled.',
