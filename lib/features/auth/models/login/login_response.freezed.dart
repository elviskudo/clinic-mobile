...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({LoginResponseData? data});
...
class _$LoginResponseImpl implements _LoginResponse {
  const _$LoginResponseImpl({this.data});
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse({final LoginResponseData? data}) =
      _$LoginResponseImpl;
...
class _$LoginResponseDataImpl implements _LoginResponseData {
  ...
  @override
  String toString() {
    return 'LoginResponseData(token: $token, userId: $userId, isVerified: $isVerified, fullName: $fullName)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, token, userId, isVerified, fullName);
